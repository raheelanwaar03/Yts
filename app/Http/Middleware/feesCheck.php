...
class feesCheck
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if (auth()->user()->status == 'rejected') {
            ...
            return redirect()->back()->with('success', 'Your details has been submited successfully our team will review your details and approve your account if given information is valid!');
        }
    }
}
