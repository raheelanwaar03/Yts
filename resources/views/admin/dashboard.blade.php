...
*{
 ...
 body {
  ...
  header .user-info {
    ...
    text-align: center;
    margin-top: 10px; /* Add some space between the logo and user info */
  }

  header .user-info img {
    display: inline-block;
    margin-right: 5px; /* Add space between user photo and username */
  }
  ...
  nav a {
    width: 23%; /* Adjust width to fit four links in one row with some spacing */
    margin: 5px 0;
    display: inline-block;
  }
  ...
  footer nav a {
    width: 48%; /* Adjust width to fit two links in one row with some spacing */
    margin: 5px 0;
  }

  /* Style for the first four links to force them in one line */
  footer nav a:nth-child(-n + 4) {
    width: 25%; /* Adjust width to fit four links in one row with some spacing */
    
  }

  /* Style for the last four links to force them in one line */
  footer nav a:nth-last-child(-n + 3) {
    width: 33.33%; /* Adjust width to fit four links in one row with some spacing */
  }
.aa{
    display: none;
}
        ...
        <div class="container-fluid">
            <div class="row justify-content-center mt-5">
                ...
                <div class="row ml-2">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-around align-items-center">
                            <a href="{{ route('Admin.Delete.Unnecessary.Users') }}" class="btn btn-primary  custom-button">Del Rejected Users</a>
                            <a href="{{ route('Admin.Delete.Pending.Users') }}" class="btn btn-primary custom-button ml-3">Del Pending Users</a>
                            <a href="{{ route('Admin.Delete.Ip') }}" class="btn btn-primary  custom-button ml-3">Make Clean</a>
                        </div>
                    </div>
                </div>
            </div>
 ...
 <div class="container hidden" id="users">
    <div class="row">
      <div class="col-12  col-md-6">
        <a href="{{asset('Admin/All/Users')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">All Users</button></a>
      </div>
      <div class="col-12  col-md-6">
        <a href="{{asset('Admin/Vistors')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">Vistors</button></a>
      </div>
      <div class="col-12  col-md-6">
        <a href="{{asset('Admin/Pending/Users')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">Pending Users</button></a>
      </div>
      <div class="col-12  col-md-6">
        <a href="{{asset('Admin/Approved/Users')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">Approved Users</button></a>
      </div>
      <div class="col-12  col-md-6">
        <a href="{{asset('Admin/Rejected/Users')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">Rejected Users</button></a>
      </div>
      <div class="col-12  col-md-6">
        <a href="{{asset('Admin/Easypaisa/Users')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">Easypaisa Users</button></a>
      </div>
    </div>
  </div>
{{-- Settings --}}
<div class="container  hidden " id="withdraw">
    <div class="col-12  col-md-12">
        <a href="{{asset('Admin/daily-task')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">Click Here To Go To Daily Tasks</button></a>
      </div>
</div>
{{-- Withdraw --}}
<div class="container  hidden" id="work">
    ...
    <div class="col-12  col-md-4">
        <a href="{{asset('Admin/Widthraw/Requests')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">Withdraw Requests</button></a>
      </div>
      <div class="col-12  col-md-4">
        <a href="{{asset('Admin/Approved/Widthraw/Requests')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">Approved Requests</button></a>
      </div>
      <div class="col-12  col-md-4">
        <a href="{{asset('Admin/Rejected/Widthraw/Requests')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">Rejected Requests</button></a>
      </div>
    </div>
</div>
{{-- settings --}}
<div class="container  hidden" id="settings">
  <div class="row">
    <div class="col-12  col-md-6">
        <a href="{{asset('Admin/Setting')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">Reward Settings</button></a>
      </div>
      <div class="col-12  col-md-6">
        <a href="{{asset('Admin/Easypaisa')}}"><button class="btn btn-primary btn-lg w-100 btn-block custom-button">Wallet Settings</button></a>
      </div>
    </div>
</div>
{{-- Product
...
{{-- <div class="container hidden" id="contact">
  ...
  <footer>
    <nav>
      <a href="#" onclick="showDashboard();"><i class="fas fa-home"></i><div>Home</div></a>
      <a href="#" onclick="showUsers();"><i class="fas fa-users"></i><div>Users</div></a>
      <a href="#" onclick="showWork();"><i class=" fas fa-dollar-sign"></i><div>Withdrawals</div></a>
      <a href="#" class="toggle-links"><i class="fas fa-bars"></i><div id="moreLessLabel">More</div></a>
      <a href="#" class="aa" onclick="showWithdraw();"><i class="fas fa-tasks"></i><div>Daily Tasks</div></a>
      <a href="#" class="aa" onclick="showSettings();"><i class="fas fa-cogs"></i><div>Settings</div></a>
   ...
   <input class="aa" type="submit" value="Logout" style="font-weight: 400;padding-left:10px !important;padding-right:10px !important;">
      </form>
  </nav>
  </footer>
...
document.addEventListener('DOMContentLoaded', function () {
        ...
        toggleLinks.forEach(function (link) {
            link.addEventListener('click', function () {
                ...
                moreLessLabel.textContent = (moreLessLabel.textContent === 'More') ? 'Less' : 'More';
            });
        });
    });
</script>
