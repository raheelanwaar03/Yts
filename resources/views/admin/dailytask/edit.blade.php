    ...
    <div class="dasboard-body">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center mt--85">
                <h2 class="text-center text-white">Edit Task Details</h2>
                <hr>
                <div class="col-md-12">
                    <div class="card">
                        <form action="{{ route('Admin.daily_task.update', $daily_task->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="form-group">
                                <label for="" class="m-3">Title</label>
                                <input type="text" name="title" value="{{ $daily_task->title }}"
                                    class="form-group">
                            </div>
                            <div class="form-group">
                                <label for="" class="m-3">Description</label>
                                <textarea name="description" value="{{ $daily_task->description }}" class="form-control" rows="7"></textarea>
                            </div>
