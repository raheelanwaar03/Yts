    ...
    <div class="dasboard-body">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center mt--85">
                <h2 class="text-center text-white">Change Email</h2>
                <hr>
                <div class="col-md-12">
                    <div class="card">
                        <form action="{{ route('Admin.Change.Email.Setting') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="" class="m-3">Email</label>
                                <input type="text" name="email" class="form-group" placeholder="Enter Email">
                            </div>
                            <div class="form-group">
                                <label for="" class="m-3">Option</label>
                ...
                <div class="col-md-12 mt-4">
                    ...
                    <table id="myTable" class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                @forelse ($email_setting as $setting)
                                    <td>{{ $setting->email }}</td>
                                    <td>{{ $setting->status == 1 ? 'ON' : 'OFF' }}</td>
                                    <td><a href="{{ route('Admin.Delete.Email', $setting->id) }}"
